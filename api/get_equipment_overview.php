...
try {
  ...
  $KW_INUSE     = ["กำลังใช้","ใช้งาน","กำลังใช้งาน","กำลังเช่า","เช่าอยู่","ถูกยืม","ยืมอยู่","กำลังยืม","กำลังให้ยืม","IN_USE","IN USE","BORROW","BORROWED","RENT","RENTED","INUSE"];
  $KW_BROKEN    = ["ชำรุด","เสีย","พัง","เสียหาย","แตก","หัก","ร้าว","ขาด","เสื่อม","เสื่อมสภาพ","BROKEN","DAMAGE","DAMAGED","DEFECT"];
  $KW_MAINT     = ["ซ่อม","ซ่อมแซม","ซ่อมบำรุง","กำลังซ่อม","กำลังซ่อมแซม","ส่งซ่อม","MAINT","MAINTENANCE","REPAIR","FIX"];
  ...
  foreach ($statusRows as $r) {
    ...
    $rawTrim = trim($raw);
    $rawUpper = mb_strtoupper($rawTrim, "UTF-8");
  ...
  // categories list (sidebar) — ไม่บังคับ category filter เพื่อให้ list หมวดครบใน scope
  $types2=""; $vals2=[]; $where2=["1=1"];
